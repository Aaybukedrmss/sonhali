        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadTimeHour = table.Column<short>(type: "smallint", nullable: false),
                    Price = table.Column<double>(type: "float", nullable: false),
                    SaleStatusCode = table.Column<byte>(type: "tinyint", nullable: false),
                    Degerlendirmelerim_Yorum = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ...
                    MedyaTipi = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Yazar = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    TopMostCategoryId = table.Column<short>(type: "smallint", nullable: false),
                    TopMostCategoryNames = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopCo", x => x.Id);
                });
